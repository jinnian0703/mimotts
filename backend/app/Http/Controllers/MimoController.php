...
class MimoController
{
    ...
    private function serializeJob(AudioJob $job): array
    {
        ...
        return [
            ...
            'filesPrunedAt' => $requestMeta['audio_files_pruned_at'] ?? null,
            'filesPrunedCount' => $requestMeta['audio_files_pruned_count'] ?? null,
            'filesPrunedReason' => $requestMeta['audio_files_pruned_reason'] ?? null,
